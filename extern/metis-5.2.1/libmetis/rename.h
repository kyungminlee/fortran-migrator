...
#define Match_JC                        libmetis_MUMPS_Match_JC
...
#define FreeSData                       libmetis_MUMPS_FreeSData
#define FreeRData                       libmetis_MUMPS_FreeRData
#define FreeGraph                       libmetis_MUMPS_FreeGraph
#define graph_WriteToDisk               libmetis_MUMPS_graph_WriteToDisk
#define graph_ReadFromDisk              libmetis_MUMPS_graph_ReadFromDisk
...
#define BalanceAndRefineLP               libmetis_MUMPS_BalanceAndRefineLP
#define BlockKWayPartitioning            libmetis_MUMPS_BlockKWayPartitioning
#define CoarsenGraphNlevels              libmetis_MUMPS_CoarsenGraphNlevels
#define ComputeBFSOrdering               libmetis_MUMPS_ComputeBFSOrdering
#define Greedy_KWayEdgeCutOptimize       libmetis_MUMPS_Greedy_KWayEdgeCutOptimize
#define Greedy_KWayEdgeStats             libmetis_MUMPS_Greedy_KWayEdgeStats
#define GrowBisectionNode2               libmetis_MUMPS_GrowBisectionNode2
#define GrowMultisection                 libmetis_MUMPS_GrowMultisection
#endif

      INTEGER FUNCTION PILAENVX_EP( ICTXT, ISPEC, NAME, OPTS,
     $                              N1, N2, N3, N4 )
*
...
*  =======
*
*  PILAENVX_EP is called from the ScaLAPACK routines to choose problem-
...
*               where k is given by PILAENVX_EP(2,...) and m by PILAENVX_EP(5,...)
...
*          be required.
*
* (PILAENVX_EP) (global output) INTEGER
*          >= 0: the value of the parameter specified by ISPEC
*          < 0:  if PILAENVX_EP = -k, the k-th argument had an illegal value.
*
*  Further Details
*  ===============
*
...
*
*     Safety: initialize the result so we can never return uninitialised
...
*     S/D/C/Z (see pjlaenv_ep.f / ilaenv_ep.f for the rationale).
...
*
      PILAENVX_EP = INT( REAL( MIN( N1, N2 ) )*1.6E0 )
      RETURN
*
  110 CONTINUE
*
...
*     PILAENVX_EP = 0
      PILAENVX_EP = 1
      IF( PILAENVX_EP.EQ.1 ) THEN
         PILAENVX_EP = IEEECK( 0, 0.0, 1.0 )
      END IF
      RETURN
*
  150 CONTINUE
...
*
      PILAENVX_EP = PIPARMQ( ICTXT, ISPEC, NAME, OPTS, N1, N2, N3, N4 )
      RETURN
*
  170 CONTINUE
*
...
*
      ...
      PILAENVX_EP = MIN( ICEIL(N1,N2), MIN( NPROW, NPCOL) )
      RETURN
*
  180 CONTINUE
*
...
*
*
      PILAENVX_EP = ICEIL(N1, ICEIL(384, N2)*N2)
      RETURN
  990 CONTINUE
*

...
*         ANB = PJLAENV_EP( DESCA( CTXT_ ), 3, 'PZHETTRD', 'L', 0, 0,
*           0, 0 )
*
...
*
      LOGICAL            LSAME
      INTEGER            ICEIL, NUMROC, PJLAENV_EP
      DOUBLE PRECISION   DZNRM2, PDLAMCH
      EXTERNAL           LSAME, ICEIL, NUMROC, PJLAENV_EP, DZNRM2, PDLAMCH
*     ..
*     .. Intrinsic Functions ..
...
*
         PNB = PJLAENV_EP( ICTXT, 2, 'PZHETTRD', 'L', 0, 0, 0, 0 )
         ANB = PJLAENV_EP( ICTXT, 3, 'PZHETTRD', 'L', 0, 0, 0, 0 )
*
         INTERLEAVE = ( PJLAENV_EP( ICTXT, 4, 'PZHETTRD', 'L', 1, 0, 0,
     $                0 ).EQ.1 )
         TWOGEMMS = ( PJLAENV_EP( ICTXT, 4, 'PZHETTRD', 'L', 2, 0, 0,
     $              0 ).EQ.1 )
         BALANCED = ( PJLAENV_EP( ICTXT, 4, 'PZHETTRD', 'L', 3, 0, 0,
     $              0 ).EQ.1 )
*

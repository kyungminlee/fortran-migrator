...
*         ANB = PJLAENV_EP( DESCA( CTXT_ ), 3, 'PDSYTTRD', 'L', 0, 0,
*           0, 0 )
*
...
*
      ...
      EXTERNAL           LSAME, ICEIL, NUMROC, PJLAENV_EP, DNRM2, PDLAMCH
*     ..
*     .. Intrinsic Functions ..
...
*
         PNB = PJLAENV_EP( ICTXT, 2, 'PDSYTTRD', 'L', 0, 0, 0, 0 )
         ANB = PJLAENV_EP( ICTXT, 3, 'PDSYTTRD', 'L', 0, 0, 0, 0 )
*
         INTERLEAVE = ( PJLAENV_EP( ICTXT, 4, 'PDSYTTRD', 'L', 1, 0, 0,
     $                0 ).EQ.1 )
         TWOGEMMS = ( PJLAENV_EP( ICTXT, 4, 'PDSYTTRD', 'L', 2, 0, 0,
     $              0 ).EQ.1 )
         BALANCED = ( PJLAENV_EP( ICTXT, 4, 'PDSYTTRD', 'L', 3, 0, 0,
     $              0 ).EQ.1 )
*

...
*        from procrow ICROW2 with offset IROFFC2), since PBZTRNV transposes
*        V into a column at ICROW2 and ZGEMV/ZGERU below act on sub(C2).
...
*        ICCOL2 with offset ICOFFC2), since the col-V SIDE='R' PBZTRNV
*        calls transpose V into a row at ICCOL2 and the downstream
*        ZGEMV/ZGERU act on sub(C2).  In the row-V SIDE='R' branch this

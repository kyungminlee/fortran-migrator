/* BI_zzvvamx2.c -- multifloats replacement for BI_zvvamx2.
 *
 * Stock BLACS ties by comparing real parts first and falling back to
 * imag parts. We replicate that structure exactly via mf_cmp on each
 * limb pair in sequence.
 */
#include "Bdef.h"

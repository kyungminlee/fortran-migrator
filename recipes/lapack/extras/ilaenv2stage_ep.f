...
*
*> \htmlonly
*> Download ILAENV2STAGE_EP + dependencies
...
*  ===========
*
*       INTEGER FUNCTION ILAENV2STAGE_EP( ISPEC, NAME, OPTS, N1, N2, N3, N4 )
*
*       .. Scalar Arguments ..
*       CHARACTER*( * )    NAME, OPTS
...
*> \verbatim
*>
*> ILAENV2STAGE_EP is called from the LAPACK routines to choose problem-dependent
*> parameters for the local environment.  See ISPEC for a description of
*> the parameters.
*> It sets problem and machine dependent parameters useful for *_2STAGE and
*> related subroutines.
*>
*> ILAENV2STAGE_EP returns an INTEGER
*> if ILAENV2STAGE_EP >= 0: ILAENV2STAGE_EP returns the value of the parameter
*>                       specified by ISPEC
*> if ILAENV2STAGE_EP < 0:  if ILAENV2STAGE_EP = -k, the k-th argument had an
*>                       illegal value.
*>
...
*> \verbatim
*>
*>  The following conventions have been used when calling ILAENV2STAGE_EP
...
*>      passed a value of -1.
*>  3)  The parameter value returned by ILAENV2STAGE_EP is checked for validity in
*>      the calling subroutine.
*>
*> \endverbatim
*>
*  =====================================================================
      INTEGER FUNCTION ILAENV2STAGE_EP( ISPEC, NAME, OPTS, N1, N2, N3,
     $                               N4 )
*
...
*     ..
*     .. External Functions ..
      INTEGER            IPARAM2STAGE_EP
      EXTERNAL           IPARAM2STAGE_EP
*     ..
...
*
      IISPEC = 16 + ISPEC
      ILAENV2STAGE_EP = IPARAM2STAGE_EP( IISPEC, NAME, OPTS,
     $                             N1, N2, N3, N4 )
      RETURN
*
*     End of ILAENV2STAGE_EP
*
      END

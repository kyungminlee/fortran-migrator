program test_dgerqf
    ...
    use target_lapack,   only: target_name, target_eps, target_dgerqf
    ...
    call report_init('dgerqf', target_name)
    do i = 1, size(ms)
        m = ms(i); n = ns(i)
        call gen_matrix_quad(m, n, A0, seed = 66001 + 59 * i)

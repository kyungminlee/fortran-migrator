program test_dsytrf_aa
    ...
    use target_lapack,   only: target_name, target_eps, target_dsytrf_aa
    use ref_quad_lapack, only: dsytrf_aa
    implicit none
    ...
    call report_init('dsytrf_aa', target_name)
    do i = 1, size(ns)
        n = ns(i)
        call gen_symmetric_matrix_quad(n, A0, seed = 21001 + 47 * i)

program test_zgttrs
    ...
    use target_lapack,   only: target_name, target_eps, target_zgttrf, target_zgttrs
    use ref_quad_lapack, only: zgttrf, zgttrs
    implicit none
    ...
    call report_init('zgttrs', target_name)
    do i = 1, size(ns)
        n = ns(i)
        call gen_vector_complex(n-1, dl0, seed = 99001 + 47 * i)
        call gen_vector_complex(n,   d0,  seed = 99011 + 47 * i)
        call gen_vector_complex(n-1, du0, seed = 99021 + 47 * i)
        call gen_matrix_complex(n, nrhs, B0, seed = 99031 + 47 * i)
        ...
        B_ref = B0; B_got = B0
        call zgttrs('N', n, nrhs, dl_ref, d_ref, du_ref, du2_ref, ipiv_ref, B_ref, n, info)
        call target_zgttrs('N', n, nrhs, dl_got, d_got, du_got, du2_got, ipiv_got, B_got, n, info)

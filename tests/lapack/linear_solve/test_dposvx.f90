program test_dposvx
    ...
    use target_lapack,   only: target_name, target_eps, target_dposvx
    use ref_quad_lapack, only: dposvx
    implicit none
    ...
    call report_init('dposvx', target_name)
    do i = 1, size(ns)
        n = ns(i)
        call gen_spd_matrix_quad(n, A0, seed = 400041 + 47 * i)
        call gen_matrix_quad(n, nrhs, B0, seed = 400051 + 47 * i)
        ...
        call dposvx('E', 'U', n, nrhs, A_ref, n, AF_ref, n, equed_ref, S_ref, &
                    B_ref, n, X_ref, n, rcond_ref, ferr_ref, berr_ref, work, iwork, info)
        call target_dposvx('E', 'U', n, nrhs, A_got, n, AF_got, n, equed_got, S_got, &

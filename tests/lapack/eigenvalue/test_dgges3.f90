! dgges3: blocked generalized Schur. SORT='N'.
program test_dgges3
    use prec_kinds,      only: ep
    use prec_report,     only: report_init, report_case, report_finalize
    use compare,         only: max_rel_err_vec
    use test_data,       only: gen_matrix_quad
    use target_lapack,   only: target_name, target_eps, target_dgges3
    use ref_quad_lapack, only: dgges3
    implicit none
    ...
    call report_init('dgges3', target_name)
    do i = 1, size(ns)
        n = ns(i)
        call gen_matrix_quad(n, n, A, seed = 122001 + 47 * i)
        call gen_matrix_quad(n, n, B, seed = 122011 + 47 * i)
        ...
        call dgges3('N', 'N', 'N', sel_all_3, n, Aref, n, Bref, n, sdim_r, &
        ...
        deallocate(work)
        call target_dgges3('N', 'N', 'N', sel_all_3, n, Agot, n, Bgot, n, sdim_g, &

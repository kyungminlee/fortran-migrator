program test_blas_zgemv2_x
    ...
    call ref_blas_zgemv2_x(blas_no_trans, m, n, alpha, a, m, head_x, tail_x, 1, &
                           beta, y_ref, 1)
    call target_blas_zgemv2_x(blas_no_trans, m, n, alpha, a, m, head_x, tail_x, 1, &
                              beta, y_got, 1)

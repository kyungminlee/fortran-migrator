program test_blas_zsbmv_x
    ...
    call ref_blas_zsbmv_x(blas_upper, n, k, alpha, a, lda, x, 1, beta, y_ref, 1)
    call target_blas_zsbmv_x(blas_upper, n, k, alpha, a, lda, x, 1, beta, y_got, 1)

program test_pzsyr2k
    ...
    do ic = 1, size(uplos)
        ...
        do i = 1, size(ns)
            ...
            call target_pzsyr2k(uplo, trans, n, k, alpha, &
            ...
            if (my_rank == 0) then
                allocate(C_ref(n, n))
                C_ref = C0
                call zsyr2k(uplo, trans, n, k, alpha, A_glob, ar, B_glob, ar, &
                            beta, C_ref, n)

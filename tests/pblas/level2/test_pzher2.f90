program test_pzher2
    ...
    do iu = 1, size(uplos)
        ...
        do i = 1, size(ns)
            ...
            call target_pzher2(uplo, n, alpha, x_loc, 1, 1, descx, 1, &
            ...
            if (my_rank == 0) then
                allocate(A_ref(n, n))
                A_ref = A_glob
                call zher2(uplo, n, alpha, x_glob, 1, y_glob, 1, A_ref, n)

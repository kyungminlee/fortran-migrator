! Test PBZTRAN — replicated-A paths (IACOL=-1 / IAROW=-1).
! Complex mirror of test_pbdtran_replicated with TRANS='C'
! (C := A^H + beta*C0). See that file for full commentary.
program test_pbztran_replicated
    ...
    call grid_init()
    call report_init('pbztran_replicated', target_name, my_rank)
...
contains
    ...
    subroutine run_case_C_iacol_neg()
        ...
        call gen_matrix_complex(m, n, A_glob, seed = 4801)
        ...
        call gen_matrix_complex(n, m, C0_glob, seed = 4901)
    ...
    subroutine run_case_R_iarow_neg()
        ...
        call gen_matrix_complex(m, n, A_glob, seed = 4811)
        ...
        call gen_matrix_complex(n, m, C0_glob, seed = 4911)
...
end program test_pbztran_replicated

! Test BLACS qtrbs2d / qtrbr2d — trapezoidal broadcast. Rank (0,0)
! broadcasts the upper trapezoid of a known matrix to all grid ranks;
! receivers verify the trapezoid is exact and off-trapezoid cells

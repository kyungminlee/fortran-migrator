program test_pzunmql
    ...
    call grid_init()
    call report_init('pzunmql', target_name, my_rank)
    ...
    do ic = 1, cases
        ...
        allocate(work(1))
        call target_pzunmql(sides(ic), transes(ic), mC, nC, k, A_loc, 1, 1, desca, &

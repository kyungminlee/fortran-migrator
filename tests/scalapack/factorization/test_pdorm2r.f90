program test_pdorm2r
    ...
    call grid_init()
    call report_init('pdorm2r', target_name, my_rank)
    ...
    do ic = 1, cases
        ...
        ! Apply Q to C.
        allocate(work(1))
        call target_pdorm2r(sides(ic), transes(ic), mC, nC, k, A_loc, 1, 1, desca, &

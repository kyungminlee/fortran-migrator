program test_pdorm2l
    ...
    call grid_init()
    call report_init('pdorm2l', target_name, my_rank)
    ...
    do ic = 1, cases
        ...
        allocate(work(1))
        call target_pdorm2l(sides(ic), transes(ic), mC, nC, k, A_loc, 1, 1, desca, &

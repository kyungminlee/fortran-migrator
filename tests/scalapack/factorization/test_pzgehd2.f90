program test_pzgehd2
    ...
    use target_scalapack, only: target_name, target_eps, target_pzgehd2
    implicit none
    ...
    call grid_init()
    call report_init('pzgehd2', target_name, my_rank)

    do i = 1, size(ns)
        n = ns(i); ilo = 1; ihi = n
        call gen_distrib_matrix_z(n, n, mb, nb, A_loc, A_glob, seed = 15301 + 31*i)
        ...
        call target_pzgehd2(n, ilo, ihi, A_loc, 1, 1, desca, tau_got, &
                            work, lwork, info)

program test_pzunm2r
    ...
    call grid_init()
    call report_init('pzunm2r', target_name, my_rank)
    ...
    do ic = 1, cases
        ...
        allocate(work(1))
        call target_pzunm2r(sides(ic), transes(ic), mC, nC, k, A_loc, 1, 1, desca, &

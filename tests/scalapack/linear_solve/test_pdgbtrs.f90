program test_pdgbtrs
    ! General banded factor (pdgbtrf) + solve (pdgbtrs) split.
    ...
    call grid_init()
    call report_init('pdgbtrs', target_name, my_rank)
    ...
    do i = 1, size(ns)
        ...
        call target_pdgbtrf(n, bwl, bwu, A_loc, 1, desca, ipiv_loc, &
                            af, laf, wopt, -1, info)
        ...
        call target_pdgbtrs('N', n, bwl, bwu, nrhs, A_loc, 1, desca, ipiv_loc, &

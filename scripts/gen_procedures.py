...
NETLIB = {
    "blas":      ROOT / "extern/lapack-3.12.1/BLAS/SRC",
    "lapack":    ROOT / "extern/lapack-3.12.1/SRC",
    "pblas":     ROOT / "extern/scalapack-2.2.3/PBLAS/SRC",
    "scalapack": ROOT / "extern/scalapack-2.2.3/SRC",
}
...
# scheme is m/w per ``codegen/targets/multifloats.yaml``.
PREFIXES = {
...
def main():
    ...
    with out_path.open("w") as f:
        ...
        f.write("Generated by `scripts/gen_procedures.py` from staged source trees at\n")

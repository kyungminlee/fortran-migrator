#include "redist.h"
#include <stddef.h>
/* $Id: pctrmr2.c,v 1.1.1.1 2000/02/15 18:04:10 susan Exp $
 * 
 * some functions used by the pctrmr2d routine see file pctrmr.c for more
 * documentation.
 * 
...
intersect(char *uplo, char *diag, Int j, Int start,
  ...
  case SENDBUFF:	/* fill buff with local elements to be sent */
    ...
    memcpy((char *) (*pptrbuff), (char *) ptrstart,
	   intervalsize * sizeof(complex));
    /* ccopy_(&intervalsize, (char *) (ptrstart), &un, (char *) (*pptrbuff),
     * &un); */
  ...
  case RECVBUFF:	/* fill local memory with the values received */
    ...
    memcpy((char *) ptrstart, (char *) (*pptrbuff),
	   intervalsize * sizeof(complex));
    /* ccopy_(&intervalsize, (char *) (*pptrbuff), &un, (char *) (ptrstart),
     * &un); */
    (*pptrbuff) += intervalsize;
    break;
